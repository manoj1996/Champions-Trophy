$(document).ready(function() {
	...
	$('#expert-slider-ind').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-aus').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-sa').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-eng').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-sl').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-nz').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-ban').owlCarousel({
	    loop:true,
	    items: 1
	})
	
	$('#expert-slider-pak').owlCarousel({
	    loop:true,
	    items: 1
	})
